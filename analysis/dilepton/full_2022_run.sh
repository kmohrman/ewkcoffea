...
time python run_dilepton.py ../../input_samples/cfgs/dilepton_skims/mc_sig_bkg_samples_2022.cfg,../../input_samples/cfgs/dilepton_skims/data_samples_2022.cfg -o dilepton_2022 -x futures -n 125
