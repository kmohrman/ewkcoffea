...
if __name__ == '__main__':
    ...
    if args.hist_list == ["few"]:
        ...
        hist_lst = ["njets", "njets_counts", "nbtagsl", "nleps", "met", "l0pt"]
    ...
    processor_instance = dilepton.AnalysisProcessor(samplesdict,wc_lst,hist_lst,ecut_threshold,do_errors,do_systs,split_lep_flavor,skip_sr,skip_cr)
