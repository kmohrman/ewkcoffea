...
time python run_wwz4l.py ../../input_samples/cfgs/wwz_analysis/mc_sig_bkg_samples_2023.cfg,../../input_samples/cfgs/wwz_analysis/data_samples_2023.cfg -o wwz_2023_test -x futures -n 63
