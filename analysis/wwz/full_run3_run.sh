...
# Run at scale with systematics (with futures) DO NOT RUN THIS ON LOGIN NODE AT UF!
...
time python run_wwz4l.py ../../input_samples/cfgs/wwz_analysis/mc_sig_bkg_samples_run3.cfg -o wwz_run3_histos_siphon -x futures -n 64 --siphon
