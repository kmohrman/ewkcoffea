...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        for obj_corr_syst_var in obj_corr_syst_var_list:
            ...
            selections.add("sr_4l_sf_presel", (pass_trg & events.is4lWWZ & bmask_exactly0loose & events.wwz_presel_sf & w_candidates_mll_far_from_z))
            selections.add("sr_4l_sf_trn"   , (pass_trg & events.is4lWWZ & bmask_exactly0loose & events.wwz_presel_sf & w_candidates_mll_far_from_z & mt2_mask))
            ...
            cat_dict = {
                "lep_chan_lst" : [
                    ...
                    "sr_4l_sf_presel", "sr_4l_sf_trn", "sr_4l_of_presel",
            ...
            exclude_var_dict = {
                "mt2" : ["all_events"],
                "ptl4" : ["all_events"],
                "j0pt" : ["all_events", "4l_presel", "sr_4l_sf_presel", "sr_4l_sf_trn", "sr_4l_of_presel", "cr_4l_sf"] + analysis_cats,
                "l0pt" : ["all_events"],
                "mll_01" : ["all_events"],
                "mllll" : ["all_events"],
                ...
                "mlb_min" : ["all_events","4l_presel", "sr_4l_sf_presel", "sr_4l_sf_trn", "sr_4l_of_presel", "cr_4l_sf"] + analysis_cats,
                "mlb_max" : ["all_events","4l_presel", "sr_4l_sf_presel", "sr_4l_sf_trn", "sr_4l_of_presel", "cr_4l_sf"] + analysis_cats,
